...
function validateInArray($cocktail_name)
{
    $cocktails =    ["Mango_mule", 
                    "Citrus_Fizz",
                    "Cucumber_Gimlet", 
                    "Magic_Apple", 
                    "Shirley_Ginger", 
...
function orderToBarmen($cocktail_name, $cocktail_item,  $min_value, $max_value)
{
    ...
    $validate_in_array = validateInArray($cocktail_name) . "</br>";
...
$min_value = 2;
$max_value = 12;
echo orderToBarmen($cocktail_name, $cocktail_item, $min_value, $max_value);